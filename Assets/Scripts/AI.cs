...
public class AI : MonoBehaviour
{
    ...
    private StateMachineMaster statemachine; //Reference to each agents own state machine
    ...
    void Start ()
    {
        ...
        statemachine = new StateMachineMaster(this); //Creating the state machine
        //statemachine.SetStartState(new runToEnemyBaseSTATE(statemachine));
    }
